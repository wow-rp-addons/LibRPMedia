...
wow_classic: deps
	lrpm-export --product=$@ --manifest=Exporter/Data/Wrath.lua --database=LibRPMedia-Wrath-1.0.lua

wow_classic_ptr: deps
	lrpm-export --product=$@ --manifest=Exporter/Data/Wrath.lua --database=LibRPMedia-Wrath-1.0.lua

wow_classic_era: deps
	lrpm-export --product=$@ --manifest=Exporter/Data/Classic.lua --database=LibRPMedia-Classic-1.0.lua

wow_classic_era_ptr: deps
	lrpm-export --product=$@ --manifest=Exporter/Data/Classic.lua --database=LibRPMedia-Classic-1.0.lua

wow: deps
	lrpm-export --product=$@ --manifest=Exporter/Data/Retail.lua --database=LibRPMedia-Retail-1.0.lua
