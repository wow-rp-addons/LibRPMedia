...
SELECT
    ...
    File.Id,
    File.ContentHash,
    GetNameForIconFile(File.Id, File.Path) AS IconName,
    IconAttribute.Width,
...
SELECT
    ...
    File.Id,
    File.ContentHash,
    GetNameForIconAtlas(UiTextureAtlasElement.Id, UiTextureAtlasElement.Name) AS IconName,
