...
Constants.IconCategoryPatterns = {
    ...
    { predicate = ( All ( Prefix "spell" , Substring "arcane" ) ), tags = { Constants.IconCategory.Mage, Constants.IconCategory.ArcaneMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "blessing" ) ), tags = { Constants.IconCategory.Paladin } },
    { predicate = ( All ( Prefix "spell" , Substring "deathknight" ) ), tags = { Constants.IconCategory.DeathKnight } },
    { predicate = ( All ( Prefix "spell" , Substring "featherfall" ) ), tags = { Constants.IconCategory.Mage } },
    { predicate = ( All ( Prefix "spell" , Substring "fire", Not ( Any ( WordPrefix "fel", WordSuffix "fel" ) ) ) ), tags = { Constants.IconCategory.Mage } },
    { predicate = ( All ( Prefix "spell" , Substring "fire" ) ), tags = { Constants.IconCategory.Warlock, Constants.IconCategory.FireMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "frost" ) ), tags = { Constants.IconCategory.Mage, Constants.IconCategory.FrostMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "frostfire" ) ), tags = { Constants.IconCategory.Mage, Constants.IconCategory.FrostMagic, Constants.IconCategory.FireMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "holy", Not ( Substring "unholy" ) ) ), tags = { Constants.IconCategory.HolyMagic , Constants.IconCategory.Priest, Constants.IconCategory.Paladin } },
    { predicate = ( All ( Prefix "spell" , Substring "nature" ) ), tags = { Constants.IconCategory.Druid, Constants.IconCategory.Shaman, Constants.IconCategory.NatureMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "polymorph" ) ), tags = { Constants.IconCategory.Mage, Constants.IconCategory.ArcaneMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "shadow" ) ), tags = { Constants.IconCategory.Priest, Constants.IconCategory.Warlock, Constants.IconCategory.DeathKnight, Constants.IconCategory.ShadowMagic } },
    { predicate = ( All ( Prefix "spell" , Substring "astral" ) ), tags = { Constants.IconCategory.Druid } },
    { predicate = ( All ( Prefix "spell" , Substring "eclipse" ) ), tags = { Constants.IconCategory.Druid } },
    { predicate = ( All ( Prefix "spell" , Substring "lunar" ) ), tags = { Constants.IconCategory.Druid } },
    { predicate = ( All ( Prefix "spell" , Substring "solar" ) ), tags = { Constants.IconCategory.Druid } },
